...
bool USP_ChooseTargetTask::PreCondition_Implementation(const USP_PlanGenInfos* Infos) const
{
...
bool USP_ChooseTargetTask::PostCondition_Implementation(USP_PlanGenInfos* Infos) const
{
...
bool USP_ChooseTargetTask::ResetPostCondition_Implementation(USP_PlanGenInfos* Infos) const
{
