#include <Tasks/Impl/SP_TargetNearestPlayerTask.h>
...
ESP_PlanExecutionState USP_TargetNearestPlayerTask::Tick(float DeltaSeconds, USP_PlannerComponent* Planner, uint8* UserData)
{
